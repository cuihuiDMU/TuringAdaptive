        ...
        success: function(data){
       	 if(data.status!="success"){
       		alert(data.status);
       		 ...
       		 /* alert(data.authoritylist[1]);
       		alert(data.authoritylist[12]); */
       	 window.location.href = "<%=request.getContextPath()%>/jsp/loginGOTO.jsp";
       	/* ?user_name="+data.name+"&user_authority="+data.authoritylist */
       	 }
        },   // success结束
		error: function(e){
		    alert("查询失败:" + e);
